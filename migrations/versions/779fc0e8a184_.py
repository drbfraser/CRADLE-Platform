...
Revision ID: 779fc0e8a184
Revises: 
Create Date: 2020-01-10 23:28:42.705833
...
def upgrade():
    ...
    sa.Column('name', sa.Enum('VHT', 'HCW', 'ADMIN', 'CHO', name='roleenum'), nullable=False),
    ...
    sa.Column('dateAssessed', sa.String(length=100), nullable=False),
    sa.Column('healthcareWorkerId', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['healthcareWorkerId'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['referralHealthFacilityName'], ['healthfacility.healthFacilityName'], ),
    sa.ForeignKeyConstraint(['userId'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
