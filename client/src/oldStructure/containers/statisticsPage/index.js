              ...
              this.props.statisticsList.pregnantWomenAssessedPerMonth ? (
                <Statistic.Group
                  ...
                  <Statistic horizontal className="statSubBox">
                    <Statistic.Value className="underlineBlue">
                      {
                        this.props.statisticsList.uniquePeopleAssesedPerMonth[
                          getMonth - 1
                        ]
                  ...
                  <Statistic horizontal className="statSubBox">
                    ...
                    <Statistic.Label className="virticalWritting">
                      PREGNANT WOMEN
                    </Statistic.Label>
                  </Statistic>
                </Statistic.Group>
            ...
            <div className="centerize">
              ...
              this.props.statisticsList.assessmentsPerMonth ? (
                <Statistic.Group
                  ...
                  <Statistic horizontal className="statSubBox">
                    <Statistic.Value className="underlinePurple">
                      {
                        this.props.statisticsList.referralsPerMonth[
                          getMonth - 1
                        ]
                  ...
                  <Statistic horizontal className="statSubBox">
                    <Statistic.Value className="underlineOrange">
                      {
                        this.props.statisticsList.assessmentsPerMonth[
                          getMonth - 1
                        ]
            ...
            <div className="centerize">
              ...
              this.props.statisticsList.pregnantWomenAssessedPerMonth ? (
                <Statistic.Group
                  ...
                  <Statistic horizontal className="statSubBox">
                    <Statistic.Value className="underlineBlack">
                      {
                        this.props.statisticsList.womenReferredPerMonth[
                          getMonth - 1
                        ]
