      ...
      <Paper sx={{ p: { xs: 2, md: 3 }, mb: 3 }}>
        ...
        <Box
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Typography variant="h5">{data.studyTitle}</Typography>
            <Button
              size="small"
              variant="outlined"
              endIcon={
          ...
          <Box sx={{ mx: 4, mb: 3 }}>
            <Box
              ...
              <WorkflowMetadata
                ...
                lastEdited={data.lastEditedOn}
                dateCreated={data.firstCreatedOn}
              />
            </Box>
          </Box>
        </Collapse>
          ...
          <Box
            ...
            <Grid container spacing={3} sx={{ mb: 2 }}>
              <Grid item xs={12} md={3}>
                <Box sx={{ textAlign: 'center' }}>
                  ...
                  <Typography variant="body1" fontWeight={600}>
                    {data.workflowStartedOn}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    by {data.workflowStartedBy}
                  </Typography>
                </Box>
              </Grid>
              ...
              <Grid item xs={12} md={3}>
                <Box sx={{ textAlign: 'center' }}>
                  ...
                  <Typography variant="body1" fontWeight={600}>
                    {data.currentIndex + 1} of {data.steps.length}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    {data.steps[data.currentIndex]?.title || 'N/A'}
                  </Typography>
                </Box>
              </Grid>
              ...
              <Grid item xs={12} md={3}>
                <Box sx={{ textAlign: 'center' }}>
                  ...
                  {!data.workflowCompletedOn && progressInfo.etaDate && (
                    <Typography variant="caption" color="text.secondary">
            ...
            {data.steps[data.currentIndex] && (
              <Box
                ...
                <Typography variant="body1" fontWeight={600}>
                  {data.steps[data.currentIndex].title}
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  {formatWhen(data.steps[data.currentIndex])}
                </Typography>
              </Box>
            )}
          </Box>
