...
import {
  HistoryManager,
  createNewHistoryManager,
} from 'src/shared/types/workflow/workflowTempalateEditorType';
import {
  initHistory,
  captureState,
  performUndo,
  ...
  canRedo,
  deepClone,
} from 'src/shared/components/workflow/workflowTemplate/workflowTemplateUtils';
...
export const useUndoRedo = (
  ...
  const init = (initialWorkflow: WorkflowTemplate) => {
    const initHistoryManager = initHistory(
      createNewHistoryManager(),
      initialWorkflow
    );
