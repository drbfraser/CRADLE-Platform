...
describe('Form templates', () => {
  ...
  it('create form', () => {
    ...
    cy.get(
      ':nth-child(3) > .MuiGrid-root > :nth-child(6) > .MuiTypography-root'
    ).click();
    cy.get('.MuiButton-contained').contains('Save').click();
    ...
    cy.contains('.MuiOutlinedInput-root', 'Field Text').clear();
    cy.contains('.MuiOutlinedInput-root', 'Field Text').type('4');
    cy.contains('.MuiOutlinedInput-root', 'English Option 1').should(
      'contain',
      'Yes'
    );
    cy.contains('.MuiOutlinedInput-root', 'English Option 2').should(
      'contain',
      'No'
    );
  ...
  it('verify form', () => {
    ...
    cy.contains('.MuiOutlinedInput-root', 'Title')
      ...
      .should('have.value', 'Dinner Party Form English');
    ...
    cy.contains('.MuiOutlinedInput-root', 'English Option 3').should(
      'contain',
      'Kosher'
    );
    cy.contains('.MuiOutlinedInput-root', 'English Option 4').should(
      'contain',
      'Halal'
    );
    cy.contains('.MuiOutlinedInput-root', 'English Option 5').should(
      'contain',
      'Other'
    );
    cy.get('.MuiButton-text').contains('Cancel').click();
    ...
    cy.get("input[name='field-type-group']")
      ...
      .and('have.value', 'text');
    cy.get(
      ':nth-child(1) > .MuiFormControl-root > .MuiInputBase-root > .MuiSelect-select'
    ).should('contain', 'Any dietary restrictions?');
    cy.get(
      ':nth-child(2) > .MuiFormControl-root > .MuiInputBase-root > .MuiSelect-select'
    ).should('contain', 'Equal to');
    // bug: other should be selected
    cy.get('.MuiButton-text').contains('Cancel').click();

    cy.get('#question_3 > .MuiTypography-root').should(
      'contain',
      'Do you have any allergies?'
    );
    cy.get('.MuiFormGroup-root > :nth-child(1) > .MuiTypography-root').should(
      'contain',
      'Yes'
    );
    cy.get('.MuiFormGroup-root > :nth-child(2) > .MuiTypography-root').should(
      'contain',
      'No'
    );
    // validate the editfield
  ...
  it('create form with multiple languages', () => {
    ...
    cy.url().should('include', '/admin/form-templates/new');
    cy.contains('.MuiOutlinedInput-root', 'Title').type(
      'Dinner Party Form Multilingual'
    );
    cy.contains('.MuiOutlinedInput-root', 'Version').clear();
    cy.contains('.MuiOutlinedInput-root', 'Version').type('1');
    ...
    cy.contains('.MuiOutlinedInput-root', 'Spanish Category Name').type(
      'Dietética'
    );
    cy.get('.MuiButton-contained').contains('Save').click();
    ...
    cy.contains('.MuiOutlinedInput-root', 'Spanish Field Text').type(
    ...
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 1').type(
      'Vegetariana'
    );
    cy.get('.MuiButton-contained').contains('Add Option').click();
    cy.contains('.MuiOutlinedInput-root', 'English Option 2').type('Vegan');
    ...
    cy.get('.MuiButton-contained').contains('Add Option').click();
    cy.contains('.MuiOutlinedInput-root', 'English Option 3').type('Kosher');
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 3').type(
    ...
    cy.contains('.MuiOutlinedInput-root', 'English Field Text').clear();
    cy.contains('.MuiOutlinedInput-root', 'English Field Text').type('4');
    cy.contains('.MuiOutlinedInput-root', 'English Option 1').should(
      'contain',
      'Yes'
    );
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 1').should(
      'contain',
      'Sí'
    );
    cy.contains('.MuiOutlinedInput-root', 'English Option 2').should(
    ...
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 2').should(
      'contain',
      'No'
    );
  ...
  it('verify form with multiple languages english', () => {
    cy.wait(1000);
    cy.get('.MuiTableBody-root')
      .contains('Dinner Party Form Multilingual')
      .siblings()
      .children()
      .find('[data-testid="EditIcon"]')
      .click();
    ...
    cy.contains('.MuiOutlinedInput-root', 'Title')
      .children('.MuiOutlinedInput-input')
      .should('have.value', 'Dinner Party Form Multilingual');
    cy.contains('.MuiOutlinedInput-root', 'Version')
      .children('.MuiOutlinedInput-input')
      .should('have.value', '1');
    cy.contains('.MuiOutlinedInput-root', 'Language')
  ...
  it('verify form with multiple languages spanish', () => {
    ...
    cy.get('.MuiTableBody-root')
      ...
      .click();
    cy.wait(1000);
    cy.contains('.MuiOutlinedInput-root', 'View Language')
      .type('Spanish')
    ...
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 3').should(
      'contain',
      'Comestible según la ley judía'
    );
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 4').should(
      'contain',
      'Halal'
    );
    cy.contains('.MuiOutlinedInput-root', 'Spanish Option 5').should(
      'contain',
      'Otra'
    );
    cy.get('.MuiButton-text').contains('Cancel').click();
  ...
  it('create form default version', () => {
    ...
    cy.url().should('include', '/admin/form-templates/new');
    cy.contains('.MuiOutlinedInput-root', 'Title').type(
      'Dinner Party Form Default Version'
    );

    cy.get('.MuiButton-contained').contains('Add Category').click();
    cy.contains('.MuiOutlinedInput-root', 'Category Name').type('Dietary');
    cy.get('.MuiButton-contained').contains('Save').click();
