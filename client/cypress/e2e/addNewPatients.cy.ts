describe('New patient', () => {
  ...
  it('load website', () => {
    ...
    cy.get('[data-testid="new-patient-button"]')
      .should('contain', 'New Patient')
      .click()
      .wait(2000);
    // cy.get('[data-testid="new-patient-button"]').click().wait(5000);
    ...
    cy.get('.MuiButton-contained').click().wait(5000);
