        ...
        branches=[
            WorkflowTemplateStepBranchModel(
                ...
                condition=RuleGroupModel(
                    id="rule-senior", rule='{">=": [{"var": "patient.age"}, 65]}'
                ),
            ),
            WorkflowTemplateStepBranchModel(
                id="branch-adult",
                ...
                condition=RuleGroupModel(
                    id="rule-adult", rule='{"<": [{"var": "patient.age"}, 65]}'
                ),
            ),
        ],
    )
...
class TestConditionalWorkflow:
    def test_senior_patient_with_high_bp_full_workflow(
        ...
        """
        user_factory.create(username="test_user_senior")
        ...
        step_eval = WorkflowService.evaluate_workflow_step(
            workflow_view, current_step.id
        )
    ...
    def test_adult_patient_with_normal_bp_full_workflow(
        ...
        """
        user_factory.create(username="test_user_adult")
