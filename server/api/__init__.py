...
def __init_patients_resources(api: Api):
    ...
    api.add_resource(
        r.PatientPregnancySummary,
        "/api/patients/<string:patient_id>/pregnancy_summary",
    )
    api.add_resource(
        r.PatientMedicalHistory,
...
def __init_patient_associations_resources(api: Api):
    import api.resources.patient_associations as r

    api.add_resource(
        r.Root,
        "/api/patientAssociations",
        endpoint="patientAssociations_root",
    )
...
def __init_medical_record_resources(api: Api):
    import api.resources.medical_records as m
    ...
    api.add_resource(
        m.SingleMedicalRecord,
        "/api/medical_records/<string:pregnancy_id>",
    )
