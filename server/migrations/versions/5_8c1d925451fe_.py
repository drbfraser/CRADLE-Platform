...
Revision ID: 5_8c1d925451fe
Revises: 4_690e8766e4ac
...
revision = "5_8c1d925451fe"
down_revision = "4_690e8766e4ac"
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "reading", sa.Column("urineTestGlu", mysql.VARCHAR(length=5), nullable=True)
    )
    op.add_column(
        "reading", sa.Column("urineTestPro", mysql.VARCHAR(length=5), nullable=True)
    )
    op.add_column(
        "reading", sa.Column("urineTestLeuc", mysql.VARCHAR(length=5), nullable=True)
    )
    op.add_column(
        "reading", sa.Column("urineTestBlood", mysql.VARCHAR(length=5), nullable=True)
    )
    op.add_column(
        "reading", sa.Column("urineTestNit", mysql.VARCHAR(length=5), nullable=True)
    )
