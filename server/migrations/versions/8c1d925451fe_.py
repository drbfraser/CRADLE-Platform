...
def downgrade():
    ...
    op.add_column(
        "reading",
        sa.Column("urineTestGlu", mysql.VARCHAR(length=5), nullable=True),
    )
    op.add_column(
        "reading",
        sa.Column("urineTestPro", mysql.VARCHAR(length=5), nullable=True),
    )
    op.add_column(
        "reading",
        sa.Column("urineTestLeuc", mysql.VARCHAR(length=5), nullable=True),
    )
    op.add_column(
        "reading",
        sa.Column("urineTestBlood", mysql.VARCHAR(length=5), nullable=True),
    )
    op.add_column(
        "reading",
        sa.Column("urineTestNit", mysql.VARCHAR(length=5), nullable=True),
    )
