...
def upgrade():
    ...
    op.add_column('followup', sa.Column('patientId', sa.String(length=50), nullable=False))
    connection.execute((
        'UPDATE followup f '
    ...
    op.create_foreign_key('fk_followup_patient_patientid', 'followup', 'patient', ['patientId'], ['patientId'])
