...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('question_lang_version', sa.Column('mcOptions', mysql.TEXT(), nullable=False))
    op.add_column('question_lang_version', sa.Column('questionText', mysql.TEXT(), nullable=False))
