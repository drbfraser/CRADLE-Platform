...
def upgrade():
    ...
    op.create_foreign_key('fk_form_form_template_form_template_id_id', 'form', 'form_template', ['formTemplateId'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_form_user_last_edited_by_id', 'form', 'user', ['lastEditedBy'], ['id'], ondelete='SET NULL')
