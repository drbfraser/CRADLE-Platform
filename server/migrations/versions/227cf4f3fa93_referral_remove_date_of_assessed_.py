...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('referral', sa.Column('dateAssessed', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True))
    op.add_column('referral', sa.Column('dateNotAttended', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True))
    op.add_column('referral', sa.Column('dateCancelled', mysql.BIGINT(display_width=20), autoincrement=False, nullable=True))
