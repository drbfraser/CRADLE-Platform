...
def downgrade():
    ...
    op.create_index(
        "ix_workflow_template_name", "workflow_template", ["name"], unique=False
    )
    op.add_column(
    ...
    op.create_index(
        "ix_workflow_instance_step_name",
        "workflow_instance_step",
        ["name"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_workflow_instance_name", "workflow_instance", ["name"], unique=False
    )
    op.add_column(
        "workflow_classification",
        sa.Column("name", mysql.VARCHAR(length=200), nullable=False),
