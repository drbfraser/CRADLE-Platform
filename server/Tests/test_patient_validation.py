...
# max gestation age weeks is 43 weeks/10 months
...
def check_gestational_age_over_limit():
    message = PatientValidation.check_gestational_age_under_limit(
        patient_request_body_gestation_over_limit
    )
    assert message == "Gestation is greater than 43 weeks/10 months."


def check_gestational_age_under_limit():
