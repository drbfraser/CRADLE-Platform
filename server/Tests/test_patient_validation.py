...
def test_check_if_required_keys_present_with_all_keys():
    ...
    valid = PatientValidation.check_if_required_keys_present(patient_request_body, required_keys)
    assert valid is None

def test_check_if_required_keys_present_with_missing_keys():
    required_keys = {"patientName", "villageNumber", "patientSex", "dob" }
    invalid_code = PatientValidation.check_if_required_keys_present(patient_request_body, required_keys)
...
def test_check_if_values_string_or_int_succeeds_with_int():
    ...
    result = PatientValidation.check_if_values_string_or_int(patient_request_body, None, must_be_int)
...
def test_check_if_values_string_or_int_succeeds_with_string_and_int():
    ...
    result = PatientValidation.check_if_values_string_or_int(patient_request_body, must_be_string, must_be_int)
    assert result is None
